...
var DynamicNewInstance = (function (_super) {
    ...
    DynamicNewInstance.of = function (key) {
        ...
        return new (DynamicNewInstance.bind.apply(DynamicNewInstance, [void 0].concat([key], dynamicDependencies)))();
    };
    DynamicNewInstance = __decorate([
